    ...
    <x-section>
        <x-box>
            ...
            <div class="space-y-6">
                ...
                <p class="max-w-prose">
                    <strong>dd Marketplace</strong> показывает доступные товары в соответствии с выбранным регионом.
                ...
                <p class="max-w-prose">
                    ...
                    через закладку или даже почтой. Это может занять от нескольких часов до нескольких дней — уточняй в конкретном магазине.
                </p>
                ...
                <p class="max-w-prose">
                    На открывшейся странице ты сможешь ввести координаты места, неподалёку от которого ты хочешь получить закладку.<br>
                </p>
